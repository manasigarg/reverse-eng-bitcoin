...
def mktx(*args):
    ...
    logger.info("txobj: {}".format(txobj))

    logger.info("ins: {}".format(ins))
    ...
    logger.info("txobj (after ins loop): {}".format(txobj))
    ...
    for key , value in txobj.items():
        logger.info("txobj - {} : {}".format(key , value))

    for key, value in txobj['ins'][0].items():
        logger.info("ins - {} : {}".format(key, value))

    for key, value in txobj['outs'][0].items():
        logger.info("outs - {} : {}".format(key, value))
